...
public class depositSystem {
	...
	public boolean saved(  String accId , String custId , String Date , int Balance , int Deposit ) throws SQLException{
		
		String query = "INSERT INTO deposit( acc_id , cust_id , date , balance , deposit ) VALUES ( ? , ? , ? , ? , ? ) ";
